...
import { ExternalLink, Trash2, ShieldAlert, Globe, ArrowRight } from "lucide-react";
...
export function BoardCard({ board, categoryLabels, onToggle, onDelete, onUsePublicUrl, inactive }: BoardCardProps) {
  return (
    <div className={`flex flex-col py-3 px-4 rounded-xl border bg-card ${inactive ? 'opacity-60 border-border' : board.is_gated ? 'border-destructive/40' : 'border-border'}`}>
